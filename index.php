        ...
        if(!empty($_POST['pseudoCon'])){
            ...
            if(!empty($_POST['motDePasseCon'])){
               ...
               $lienFichierBDD = "database/configdatabase.php";
                ...
                $conMembre->setPseudo($_POST['pseudoCon']);
                $conMembre->setMotDePasse($_POST['motDePasseCon']);
                
                $pseudoCon = $conMembre->getPseudo();
                $motDePasseCon = $conMembre->getMotDePasse();

                $conMembre->connexionMembre($pseudoCon, $motDePasseCon, $lienFichierBDD, $lienPageAccueil );

                if($conMembre->connexionMembre($pseudoCon, $motDePasseCon, $lienFichierBDD, $lienPageAccueil) == false){
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="row d-flex justify-content-center formulaire pt-2 pb-2">
                ...
                <div class="row d-flex justify-content-center form-input">
                    ...
                    <p class="text-white text-wrap">Vous n'avez pas encore de compte ? <a
                            href="inscription.php">Inscrivez-vous ici</a></p>
