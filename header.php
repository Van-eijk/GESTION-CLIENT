<nav class="navbar navbar-expand-md nav-responsive navbar-dark fixed-top">
        <div class="container main-nav">
            ...
            <button class="navbar-toggler btn-danger" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a href="profilmembre.php" class="nav-link text-dark">Mon profil</a>
                    </li>

                    <li class="nav-item">
                        <a href="index.php" class="nav-link text-dark">Se déconnecter</a>
                    </li>
                </ul>
