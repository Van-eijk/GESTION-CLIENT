<?php 
    ...
    if(isset($_SESSION['codeDeVerification'])){


        $code = $_SESSION['codeDeVerification'] ;


        if(isset($_POST['verifier'])){

            
            $codeUser = (int)$_POST['codeverif']; // Conversion en un nombre entier
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="row d-flex justify-content-center formulaire pt-5 pb-5">
                        ...
                        <div class="row d-flex justify-content-center form-input">
                            <form action="codeverification.php" method="post" class="mb-3">

                                
                                <div class="form-floating mb-3">
                                    <input type="number" name="codeverif" class="form-control form-control-sm " id="floatingInput" placeholder="Code">
                                    <label for="floatingInput">Code</label>
                                </div>
                                

                                <div class="row d-flex justify-content-center ">
                                    <button type="submit" class="btn btn-danger w-25 p-2" name="verifier">Vérifier</button>
...
<?php 
        ...
        echo "Générez un code de vérification" ;
    }
?>
